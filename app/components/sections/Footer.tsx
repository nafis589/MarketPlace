    ...
    return (
        <footer className="bg-black text-white pt-20 pb-10 px-4 md:px-8">
            <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                ...
                <div>
                    <h3 className="text-lg font-serif font-medium mb-6">Aide & Support</h3>
                    <ul className="flex flex-col gap-3 text-sm text-gray-400">
                        <li><Link href="#" className="hover:text-white transition-colors">Centre d'aide</Link></li>
                        <li><Link href="#" className="hover:text-white transition-colors">Vendre</Link></li>
                        <li><Link href="#" className="hover:text-white transition-colors">Acheter</Link></li>
                        <li><Link href="#" className="hover:text-white transition-colors">Authentification</Link></li>
            ...
            <div className="max-w-[1600px] mx-auto pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
                <p className="text-sm text-gray-500">© 2024 FriperieLuxe. Tous droits réservés.</p>
